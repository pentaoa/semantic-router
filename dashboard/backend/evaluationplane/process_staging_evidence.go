...
// Evidence publication is serialized because canonical CAS objects and live
// execution attestations are shared store facts. This keeps worker import,
// server attestation, report anchoring, deletion, and crash recovery from
// observing one another's partial publication windows.
var runEvidencePublicationMu sync.Mutex
