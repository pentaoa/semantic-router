...
func writeMixedEvidenceFixture(t *testing.T, routingKind string) mixedEvidenceFixture {
	...
	routingRevision := writeImportedSuiteFixture(t, service.suiteStorePath, "mixed-routing", importedSuiteFixtureOptions{
		adapterID: "routerarena", trackIDs: []TrackID{"routing"},
	})
	poolRevision := writeImportedSuiteFixture(t, service.suiteStorePath, "mixed-pool", importedSuiteFixtureOptions{
...
func TestSyntheticMoMReplayIsPermanentlyE0(t *testing.T) {
	...
	manifest.SuiteExecutors["live-mom-core"] = momReplayExecutorID
	levels, err := deriveSealedEvidenceLevels(
