...
func methodMetricExpectations(methods methodRecordAttestation, selectedTracks []TrackID) map[string]methodMetricExpectation {
	...
	var recoveryPairs, distinctSeeds, minimumSeeds *float64
	...
	add("agentic", "agentic.recovery_pass_rate", "Injected-failover recovery pass rate", "fraction", "higher_is_better", recovery.PassRate, recovery.PairCount, nil)
	add("agentic", "agentic.recovery_pass_rate_lower_95", "One-sided 95% recovery pass-rate lower bound", "fraction", "higher_is_better", recovery.PassRateLower95, recovery.PairCount, nil)
	add("agentic", "agentic.recovery_treatment_success_rate", "Treatment continuity success rate", "fraction", "higher_is_better", recovery.TreatmentSuccessRate, recovery.PairCount, nil)
	add("agentic", "agentic.recovery_baseline_success_rate", "Paired baseline continuity success rate", "fraction", "higher_is_better", recovery.BaselineSuccessRate, recovery.PairCount, nil)
	add("agentic", "agentic.recovery_success_delta", "Treatment minus baseline continuity success", "fraction", "higher_is_better", recovery.SuccessDelta, recovery.PairCount, nil)
	add("agentic", "agentic.recovery_mean_latency_delta_ms", "Treatment minus baseline recovery latency", "ms", "lower_is_better", recovery.MeanLatencyDeltaMS, recovery.PairCount, nil)
