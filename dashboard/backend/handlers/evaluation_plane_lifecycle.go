...
func (wire evaluationLifecycleUpdateWireRequest) domainRequest() (evaluationplane.UpdateRunLifecycleRequest, error) {
	request := evaluationplane.UpdateRunLifecycleRequest{}
