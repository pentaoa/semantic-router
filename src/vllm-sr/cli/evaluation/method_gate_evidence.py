...
from cli.evaluation.gates import GateEvidenceContext
...
def derive_method_gate_evidence(
    ...
    *,
    ...
    return GateEvidenceContext(
        ...
        trajectory_qualified=recovery.passed,
        recovery_pass_rate_lower_bound=recovery.pass_rate_lower_confidence_bound,
        recovery_minimum_pass_rate_lower_bound=(
            MINIMUM_RECOVERY_PASS_RATE_LOWER_BOUND if recovery.pair_count else None
        ),
