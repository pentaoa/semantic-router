...
from cli.evaluation.contracts import CapacityLoadProtocol, CapacitySLO, StrictModel
...
class CapacityProfileLevel(StrictModel):
    ...
    def validate_internal_reduction(self) -> CapacityProfileLevel:
        ...
        expected = (
            ...
            self.errors / self.measurement_requests,
            one_sided_wilson_upper(self.errors, self.measurement_requests),
        )
        observed = (
            self.throughput_rps,
            self.throughput_cv,
...
def _level_flags(
    ...
    scaling: float | None,
    envelope_open: bool,
) -> tuple[float | None, bool, bool, bool, bool, bool, bool, bool, bool]:
...
def _unqualified_capacity_level(
    ...
    return CapacityProfileLevel(
        ...
        error_rate=errors / len(measurement_rows),
        error_rate_upper_bound=one_sided_wilson_upper(errors, len(measurement_rows)),
