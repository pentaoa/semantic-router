...
from cli.evaluation.benchmark_normalization_registry import get_benchmark_normalizer
...
from cli.evaluation.benchmark_normalizers_routing import (
...
_PARSERS: dict[str, NativeParser] = {
    "routerarena": normalize_routerarena,
    "coderouterbench": normalize_coderouterbench,
    "llmrouterbench": normalize_llmrouterbench,
    "routerbench": normalize_routerbench,
    "xroutebench": normalize_xroutebench,
    "twinrouterbench": normalize_twinrouterbench,
    "mmr-bench": normalize_mmr_bench,
    "acebench": normalize_acebench,
    "continuity-bench": normalize_continuitybench,
    "fusionfactory": normalize_fusionfactory,
    "r2-router": normalize_r2_router,
}
