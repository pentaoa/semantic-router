...
class GateEvidenceContext:
    ...
    recovery_pass_rate_lower_bound: float | None = None
    recovery_minimum_pass_rate_lower_bound: float | None = None
...
EVIDENCE_REFS_BY_GATE = {
    ...
    "G6": ("records.jsonl", "metric:agentic.recovery_pass_rate_lower_95"),
    "G7": (
        "run-manifest.json",
